...
## About this corpus
This package contains a Jacaltek/Poptiʼ corpus extracted from the _Diccionario jacalteco_, published by the [Proyecto Lingüístico Francisco Marroquín]()https://plfm.org/ (PLFM).
